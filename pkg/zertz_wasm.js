/* @ts-self-types="./zertz_wasm.d.ts" */

export class ZertzGame {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ZertzGameFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_zertzgame_free(ptr, 0);
    }
    /**
     ...
     * @returns {string}
     */
    best_move(eval_fn, simulations, c_puct) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.zertzgame_best_move(this.__wbg_ptr, eval_fn, simulations, c_puct);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {Promise<any>}
     */
    best_move_nn(eval_fn, simulations, c_puct) {
        const ret = wasm.zertzgame_best_move_nn(this.__wbg_ptr, eval_fn, simulations, c_puct);
        return ret;
    }
    /**
     ...
     * Run this in a Web Worker to avoid blocking the main thread.
     * @param {number} simulations
     * @param {number} rollouts_per_leaf
     * @param {number} c_puct
     * @returns {string}
     */
    best_move_random(simulations, rollouts_per_leaf, c_puct) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.zertzgame_best_move_random(this.__wbg_ptr, simulations, rollouts_per_leaf, c_puct);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    board_str() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.zertzgame_board_str(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    capture_counts() {
        const ret = wasm.zertzgame_capture_counts(this.__wbg_ptr);
     ...
     */
    cell_states() {
        const ret = wasm.zertzgame_cell_states(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
     ...
     */
    encode() {
        const ret = wasm.zertzgame_encode(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    is_mid_capture() {
        const ret = wasm.zertzgame_is_mid_capture(this.__wbg_ptr);
        return ret !== 0;
    }
    constructor() {
        const ret = wasm.zertzgame_new();
        this.__wbg_ptr = ret >>> 0;
        ZertzGameFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * 0 = Player1, 1 = Player2.
     ...
     */
    next_player() {
        const ret = wasm.zertzgame_next_player(this.__wbg_ptr);
        return ret;
    }
    /**
     * "ongoing" | "p1" | "p2" | "draw"
    ...
    outcome() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.zertzgame_outcome(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    play(move_str) {
        ...
        const ret = wasm.zertzgame_play(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     */
    supply_counts() {
        const ret = wasm.zertzgame_supply_counts(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
     ...
     */
    valid_moves() {
        const ret = wasm.zertzgame_valid_moves(this.__wbg_ptr);
        return ret;
    }
}
if (Symbol.dispose) ZertzGame.prototype[Symbol.dispose] = ZertzGame.prototype.free;

/**
 * @returns {number}
 */
export function board_cell_count() {
    const ret = wasm.board_cell_count();
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function board_flat_size() {
    const ret = wasm.board_flat_size();
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function cap_head_size() {
    const ret = wasm.cap_head_size();
    return ret >>> 0;
}
 ...
 * @returns {Int8Array}
 */
export function hex_coords() {
    const ret = wasm.hex_coords();
 ...
 * @returns {number}
 */
export function place_head_size() {
    const ret = wasm.place_head_size();
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function reserve_size() {
    const ret = wasm.reserve_size();
    return ret >>> 0;
}
...
const ZertzGameFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_zertzgame_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('zertz_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
